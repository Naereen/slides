...
\begin{frameO}[Hypotheses ($1/2$)]
    ...
    \begin{orangeblock}{Emission model}
    ...
    \begin{orangeblock}{Background traffic}
...
\begin{frameO}[Hypotheses ($2/2$)]
    ...
    \begin{orangeblock}{Dynamic radio reconfiguration}
...
\begin{frameO}[Optimal centralized strategy]
    ...
    \begin{orangeblock}{But unrealistic}

        But \textbf{not achievable in practice}: there is no oracle and no centralized supervision!

    \end{orangeblock}

    \begin{orangeblock}{Let see \emph{realistic decentralized approaches}}
...
\begin{frameO}[Multi-Armed Bandit formulation]
    ...
    \begin{orangeblock}{Reinforcement Learning interpretation}
...
\begin{frameO}[Experimental setting]
    ...
    \begin{orangeblock}{Simulation parameters}
    ...
    \begin{orangeblock}{What do we show}
