...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | c | c | c | m{3cm} }
            ...
            \hline
            % \vspace*{3pt}
            \textcolor{blue}{\small \textbf{MCTopM klUCB}} & \textcolor{gray}{[6]} & $\textcolor{red}{M^2} \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{$\star$$\star$$\star$}} & {\textcolor{orange}{€€}} & just $M$ \\
            \hline
...
\begin{frame}[shrink=20]
    ...
    \begin{tabular}{ m{3.5cm} | c | c | c | c | m{3cm} }
        ...
        \hline
        Discounted UCB & \textcolor{gray}{[2]} & $\textcolor{red}{\mathbf{C}_2} \sqrt{T \Upsilon_T} \textcolor{red}{\log(T)}$ & {\textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & needs $T$, $\Upsilon_T$ \\
        Sliding-Window UCB & \textcolor{gray}{[2]} & $\textcolor{red}{\mathbf{C}_2'} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & needs $T$, $\Upsilon_T$ \\
        \hline
        Exp3.S & \textcolor{gray}{[3]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & needs $\Upsilon_T$ \\
        ...
        \hline
        CUSUM-UCB & \textcolor{gray}{[5]} & $\textcolor{red}{\mathbf{C}_5} \sqrt{T \Upsilon_T \log(\frac{T}{\Upsilon_T})}$ & {\textcolor{orange}{$\star$$\star$$\star$}}  & {\textcolor{orange}{€€€}}& {\footnotesize needs $T$, $\Upsilon_T$ \textcolor{red}{and $\delta_{\min}$}} \\
        % \hline
        M-UCB & \textcolor{gray}{[6]} & $\textcolor{red}{\mathbf{C}_6} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$$\star$}} & {\textcolor{orange}{€€}} & {\footnotesize needs $T$, $\Upsilon_T$ \textcolor{red}{and $\delta_{\min}$}} \\
        \hline
        \textbf{\textcolor{blue}{BGLR + kl-UCB}} & \textcolor{gray}{[7]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$$\star$$\star$$\star$}} & {\textcolor{orange}{€€€}} & needs $T$, $\Upsilon_T$ \\
        \hline
