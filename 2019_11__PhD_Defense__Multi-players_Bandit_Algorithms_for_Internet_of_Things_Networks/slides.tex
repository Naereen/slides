...
\begin{frameO}[Other asymptotic lower bounds]
    ...
    \begin{colorblock}{For multi-player bandit}
        Same lower-bound for a problem-dependent constant $C$
...
\begin{frameO}[We implemented this with real hardware demo ICT 2018]
    TODO
...
\begin{frameTI}
    \begin{center}
        {\textcolor{white} {\Huge \textsc{GOther Bandit Models} }}
    \end{center}
    \vspace*{-4pt}
\end{frameTI}
