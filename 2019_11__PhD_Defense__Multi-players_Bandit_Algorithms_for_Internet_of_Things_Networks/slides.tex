...
\begin{frameO}[Target of this study]
    ...
    \begin{darkblock}{Wireless networks\dots}
        ...
        \hspace{35pt} $\hookrightarrow$ we focus on the case of \textbf{\alert{Internet of Things}} networks (IoT) in unlicensed bands.
    \end{darkblock}
...
\begin{frameO}[Contributions of my thesis highlighted today]
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[>=latex',line join=bevel,scale=2.25]
            ...
            \node[align=center] (chapter3) at (-2.5,2.25) [rectangle,draw,fill=green!15] {Chapter~3\\SMPyBandits: simulation\\library for MAB};
