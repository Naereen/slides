...
\begin{frame}[shrink=30]
    ...
    \begin{tabular}{l | c | c | c | c}
        ...
        \hline
        UCB etc & \textcolor{gray}{[Auer et al. 2002]} & $O(\sum\limits_{k=1}^{K} \frac{1}{\Delta_k^2} \log(T))$ & {\Large \textcolor{orange}{$\star$}} & none \\
        kl-UCB etc & \textcolor{gray}{[Garivier et al. 2013]} & $O(\sum\limits_{k=1}^{K} \frac{\Delta_k}{\kl(\mu_k,\mu^*)} \log(T))$ & {\Large \textcolor{orange}{$\star\star$}} & none \\
    \end{tabular}
