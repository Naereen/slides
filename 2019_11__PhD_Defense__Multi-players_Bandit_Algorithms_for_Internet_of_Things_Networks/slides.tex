...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | m{2.7cm} | m{2cm} | m{1.5cm} | m{3cm} }
            ...
            \hline
            MEGA & \textcolor{gray}{[3]} & $\textcolor{red}{T^{3/4}}$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & {\footnotesize 4 parameters, \emph{impossible to tune} } \\
            \hline
...
\begin{frame}[shrink=25]
    ...
    \begin{tabular}{ m{3.5cm} | c | c | m{1.5cm} | m{1.5cm} | m{3cm} }
        \textbf{Algorithm} & \textbf{Paper} & \textbf{Regret}
        & \textbf{Efficiency} \newline \textcolor{gray}{($\star\star\star\star$ is better)}
        & \textbf{Cost} \newline \textcolor{gray}{(€ is better)}
        & \textbf{Parameters} \\
        \hline
        Oracle-Restart UCB & [1] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}} \Upsilon_T \log(T))$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & \textcolor{red}{unrealistic oracle} \\
        Naive UCB & [1] & \textcolor{red}{$\mathcal{O}(T)$} in worst case& {\Large \textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & \textbf{none} \\
        \hline
        Discounted UCB & [2] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T} \textcolor{red}{\log(T)})$& {\Large \textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & needs $\Upsilon_T$ \\
        Sliding-Window UCB & [2] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)})$& {\Large \textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & needs $\Upsilon_T$ \\
        \hline
        Exp3.S & [3] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & $(\varepsilon_t)_t$ needs $\Upsilon_T$ \\
        \hline
        CUSUM-UCB & [4] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(\frac{T}{\Upsilon_T})})$ & {\Large \textcolor{orange}{$\star\star$}}  & {\textcolor{orange}{€€€}}& needs $\Upsilon_T$ and $\delta$ \\
        \hline
        M-UCB & [5] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star\star$}} & {\textcolor{orange}{€€}} & needs $\Upsilon_T$ and $\delta$ \\
        \hline
        \textbf{\textcolor{blue}{GLRT + kl-UCB}} & [6] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€€€}} & needs $\Upsilon_T$ \\
        \hline
        AdSwitch & [7] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€€€€}} & \textbf{none} \\
        \hline
        Ada-ILTCB+ & [8] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{?}} & {\textcolor{orange}{€€€€€}} & \textbf{none}
    \end{tabular}
    ...
    and $\delta$ is a lower-bound on $\Delta_{\text{change}}$ the problem difficulty.
    ...
    \begin{small}
        \textbf{References:}
            ...
            % [2] \textcolor{gray}{[Auer et al. 2002]}
            [2] \textcolor{gray}{[Garivier et al. 2009]}
            % [4] \textcolor{gray}{[Garivier et al. 2009]}
            [3] \textcolor{gray}{[Auer et al. 2002]}
            [4] \textcolor{gray}{[Liu et al. 2018]}\\
            \hspace{20pt}
            [5] \textcolor{gray}{[Cao et al. 2019]}
            [6] \textcolor{gray}{[Besson et al. 2019]}
            [7] \textcolor{gray}{[Auer et al. 2019]}
            [8] \textcolor{gray}{[Chen et al. 2019]}
    \end{small}
