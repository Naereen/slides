...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | m{2.7cm} | m{2cm} | m{1.5cm} | m{3cm} }
            \textbf{Algorithm} & \textbf{Paper} & \textbf{Regret bound}
            ...
            \hline
            \textsc{MEGA} & \textcolor{gray}{[3]} & $\textcolor{red}{T^{3/4}}$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & {\footnotesize 4 params, \emph{impossible to tune} } \\
            \hline
            Musical Chair & \textcolor{gray}{[4]} & ${2M \choose M} \textcolor{red}{\mathbf{C}'} \log(T)$ & {\Large \textcolor{orange}{$\star\star$}} & {\textcolor{orange}{€}} & {\footnotesize 1 parameter $T_0$ \newline \emph{very hard to tune} } \\
            \hline
