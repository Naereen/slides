...
\begin{frameO}[Conclusion from part I : Selfish MAB learning for IoT]
    ...
    \begin{itemize}
        \item multi-player bandits: devices are always activated ($p=1$, $D = M \leq \frac{K}{p} = K$)
...
\begin{frame}[c]
    \begin{changemargin}{-0.5cm}{-0.5cm}
        \begin{center}
            ...
            \hfill{}\small{\textcolor{gray}{Ref: Chapter 6 of my thesis, and [Besson \& Kaufmann, 2018].}}
            \\[0.5cm]
            \textcolor{darkgray}{\textbf{\Large Piece-wise stationary bandits}\\[0.5cm]}
        \end{center}
    \end{changemargin}
...
\begin{frame}[c]
    \begin{changemargin}{-0.5cm}{-0.5cm}
        \begin{center}
            ...
            \hfill{}\small{\textcolor{gray}{Ref: Chapter 7 of my thesis, and [Besson \& Kaufmann, 2019].}}
        \end{center}
    \end{changemargin}
\end{frame}
