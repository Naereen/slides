...
\begin{frameO}[We implemented this with real hardware ($1/3$)]
    ...
    \begin{center}
        \movie{\includegraphics[width=0.75\textwidth]{screenshotDemoYouTube.png}}{videos/demoICT2018.mkv}
    \end{center}
...
\begin{frameO}[Conclusion from part I : Selfish MAB learning for IoT]
    ...
    \vfill{}
    We can study two other more specific models, in two directions
    \begin{itemize}
