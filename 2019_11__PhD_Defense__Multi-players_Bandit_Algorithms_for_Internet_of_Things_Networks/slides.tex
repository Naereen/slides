...
\setbeamertemplate{footline}{ \hspace{5em} \textcolor{white} {Lilian Besson - \emph{MAB Algorithms for IoT Networks} \hfill 20 November, 2019}\hspace{2em}\null \vspace*{3pt}}
\begin{frame}{#1}
\BODY
\end{frame}
}
        ...
        \begin{itemize}
            ...
            \item \underline{Supervisors}:
                \begin{itemize}
                    ...
                    \item
                    and Dr. Émilie Kaufmann at SequeL team, in CNRS and Inria in Lille
                \end{itemize}
        \end{itemize}
    \end{Large}
...
\begin{frameO}[The ``Internet of Things'']
    ...
    % \hfill{}
    {\tiny \textcolor{gray}{
        Images from \texttt{IBM.com/blogs/internet-of-things/what-is-the-iot}
        % \texttt{YouTu.be/QSIPNhOiMoE} and
        and \texttt{www.globalsign.com/en/blog/}\\
...
\begin{frameO}[Piece-wise stationary bandits]
    ...
    \begin{blueblock}{Stationary MAB problems}
        Arm $k$ \slotmachine{} samples rewards from \textcolor{blue}{the same distribution} for any time step
...
\begin{frameO}[Backup slides to answer predicatable questions?]
    ...
    \begin{itemize}
        \item pseudo code of Rand-Top-$M$ + klUCB
        \item pseudo code of MC-Top-$M$ + klUCB
        \item exact regret bound of MC-Top-$M$ + klUCB
        % \item drawing explaining the proof of regret bound of MCTopM + klUCB
    \end{itemize}

    \begin{itemize}
        \item pseudo code of GLRT + klUCB
        \item exact regret bound of GLRT + klUCB
    \end{itemize}
...
\begin{frameO}[Lemma: bad selections for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__lemma_MCTopM_bad_selections.png}
    \end{center}
\end{frameO}

\begin{frameO}[Lemma: collisions for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__lemma_MCTopM_collisions.png}
    \end{center}
\end{frameO}

\begin{frameO}[Theoreom: regret for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__lemma_MCTopM_regret.png}
    \end{center}
\end{frameO}
...
\begin{frameO}[Theorem: regret bound for GLRT + kl-UCB (global)]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__lemma_GLR_regret.png}
    \end{center}
\end{frameO}

\begin{frameO}[Corollary: regret bounds for GLRT + kl-UCB (global)]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__cor_GLR_regret.png}
    \end{center}
\end{frameO}
...
\begin{frameO}[Theorem: regret bound for GLRT + kl-UCB (local)]
    \begin{center}
        \includegraphics[width=0.99\textwidth]{Backup_Slides__lemma_GLRlocal_regret.png}
    \end{center}
\end{frameO}
