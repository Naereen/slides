...
\begin{frameO}[Multi-players bandits: setup]
    ...
    At round $t$:
    \begin{itemize}
        \item player $m$ selects arm $A_{m,t}$ \slotmachine{} ; then \textit{observes} $r_{A_{m,t},t}$
...
\begin{frameO}[M-P bandits for Cognitive Radios: previous model]
    ...
    \begin{colorblock}{``Listen before talk''
        ...
        \begin{itemize}
            \item
            Good model for \underline{\orange Opportunistic Spectrum Access} (OSA)
...
\begin{frameO}[M-P bandits for Cognitive Radios: our models]
    ...
    \begin{colorblock}{``Talk and maybe collide''
        ...
        \begin{itemize}
            \item
            Good model for \underline{\orange Internet of Things} (IoT)

            \item
            Do not do any sensing, just transmit, and wait for an acknowledgment before any next message.

            \item
            Feedback model: observe only the joint information $r_{m, t}$.\\
...
\begin{frameO}[Multi-players bandits: algorithms]
    ...
    \only<1>{
        \begin{colorblock}{Old idea: UCB1 index + $\rho^{\text{rand}}$ rule}
            \begin{itemize}
