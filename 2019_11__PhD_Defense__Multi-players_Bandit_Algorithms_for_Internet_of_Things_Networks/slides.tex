...
\begin{frame}[shrink=25]
    ...
    \begin{tabular}{ m{3.5cm} | c | m{3.3cm} | m{2cm} | m{1.5cm} | m{3cm} }
        ...
        & \textbf{Parameters} \\
        \hline
        Oracle-Restart UCB & \textcolor{gray}{[1]} & $\textcolor{blue}{\mathbf{C}} \Upsilon_T \log(T)$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & {\footnotesize \textcolor{red}{unrealistic oracle}} \\
        ...
        \hline
        Exp3.S & \textcolor{gray}{[3]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & needs $\Upsilon_T$ \\
        Discounted TS & \textcolor{gray}{[4]} & \emph{not yet proved} & {\Large \textcolor{orange}{$\star\star$}}  & {\textcolor{orange}{€}} & {\footnotesize how to tune $\gamma$ ?} \\
        \hline
