...
\newcommand{\tgv}{\includegraphics[height=0.32cm]{high-speed-train_1f684.png}}
\newcommand{\slotmachine}{\includegraphics[height=0.33cm]{slot-machine_1f3b0.png}}
...
\begin{frameO}[Outline of this talk]
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \emph{Two tractable models}, extending the stationary single-player bandit model
        \begin{itemize}
...
\begin{frameTI}
    ...
    % \hfill{} {\tiny \textcolor{gray}{[Bonnefoi, Besson et al, CROWNCOM 2017], Ch.5}}
\end{frameTI}
...
\begin{frameO}[Multi-players bandits: setup]
    ...
    At round $t$:
    \begin{itemize}
        \item player $m$ selects arm $A_{m,t}$ \slotmachine{} ; then \textit{observes} $X_{A_{m,t},t}$
...
\begin{frameO}[M-P bandits for Cognitive Radios: our models]
    ...
    \begin{colorblock}{``Observe collision then talk?''
        ...
        \begin{itemize}
            ...
            {\small \alert{(unrealistic from cognitive radio)}}
        \end{itemize}
    \end{colorblock}
...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | c | c | c | m{3cm} }
            ...
            & \parbox[c]{2cm}{\textbf{Regret} \newline {\footnotesize \textcolor{gray}{\etoilenorm{} is worst}}}
            & \parbox[c]{1.5cm}{\textbf{Speed} \newline {\footnotesize \textcolor{gray}{\tgvsmall{} is worst}}}
            & \textbf{Parameters} \\
            \hline
            \textcolor{deeppurple}{Centralized multiple-play klUCB} & \textcolor{gray}{[1]} & $\textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}}} & {just $M$ but \newline \textcolor{deeppurple}{in another model!} } \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            $\rho^{\text{rand}}$ UCB & \textcolor{gray}{[2]} & $\textcolor{red}{M^3 \mathbf{C}_2} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}\tgv{}}} & just $M$ \\
            \hline
            \textsc{MEGA} & \textcolor{gray}{[3]} & $\mathbf{C}_3 \textcolor{red}{T^{3/4}}$ & {\textcolor{orange}{\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}}} & {\footnotesize 4 params, \newline \textcolor{red}{\emph{impossible to tune}} } \\
            \hline
            Musical Chair & \textcolor{gray}{[4]} & $\textcolor{red}{{2M \choose M} \mathbf{C}_4} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}\tgv{}}} & {\footnotesize 1 parameter $T_0$ \newline \textcolor{red}{\emph{hard to tune}} } \\
            \hline
            Selfish UCB & \textcolor{gray}{[5]} & $\textcolor{red}{T}$ in some case & {\textcolor{orange}{\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}\tgv{}}} & \textbf{none!} \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            \textcolor{orange}{\small \textbf{MCTopM klUCB}} & \textcolor{orange}{[6]} & $\textcolor{red}{M^2} \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}\tgv{}}} & just $M$ \\
            \hline
            \textsc{Sic-MMAB} & \textcolor{gray}{[7]} & $\textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}\tgv{}}} & \textbf{none!}
            % \\
...
\begin{frameO}[Conclusion: what we showed \hfill{} ($1/2$)]
    ...
    % \begin{colorblock}{What we showed}
        ...
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item for multi-player bandits with $M \leq K$ players,
                \item for piece-wise stationary bandits.
            \end{itemize}
        \end{itemize}
    % \end{colorblock}
    ...
    % \begin{lightblock}{What could be done with another year(s) ?}
        ...
        \begin{itemize}[<+->]
            ...
            \item unify the \emph{multi-player} and \emph{non-stationary} bandit models\\
                {\small $\hookrightarrow$ in progress: already one paper (\texttt{arXiv:1812.05165}), we can probably do a better job with our tools!}
            \item test our idea and our proposed algorithms in real-world environments\\
                {\small $\hookrightarrow$ was started in summer $2019$ with an intern working with Christophe Moy}
            \vspace*{10pt}
            \item the ``Graal'' goal:
                {\small try to also let the devices learn \emph{when} to transmit (choose time), not only \emph{where/how} to transmit (choose frequency, etc)\dots
                % \hfill{}
