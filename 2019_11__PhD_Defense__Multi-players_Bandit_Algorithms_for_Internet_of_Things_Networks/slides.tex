...
\begin{frame}[shrink=22]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | c | c | c | m{3cm} }
            ...
            \hline
            % \vspace*{3pt}
            \textcolor{orange}{MC-Top-$M$ klUCB} & \textcolor{orange}{[6]} & $\textcolor{red}{M^2} \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{\etoile{}\etoile{}\etoile{}\etoile{}}} & {\textcolor{orange}{\tgv{}\tgv{}}} & just $M$ \\
            \hline
    ...
    \begin{colorblock}{Typical regime for piece-wise stationary bandits}
        \begin{itemize}
            ...
            \item
                ...
                \hfill{} \gray [Besson \& Kaufmann, 2019]
                % \texttt{arXiv:1902.01575}
        \end{itemize}
    \end{colorblock}
...
\begin{frameO}[Conclusion: what we showed \hfill{} ($1/4$)]
    ...
    % \begin{colorblock}{What we showed}
        ...
        \begin{itemize}[<+->]
            \setlength\itemsep{6pt}
        \item Theoretical results in two simplified (tractable) models:
            \begin{itemize}
...
\begin{frameO}[What could be done with another year(s) ? \hfill{} ($4/4$)]
    ...
    % \begin{lightblock}{What could be done with another year(s) ?}
        ...
        \begin{itemize}[<+->]
            ...
            \item test our idea and proposed algorithms in real-world IoT environments\\
                \textcolor{gray}{\small $\hookrightarrow$ was started in summer $2019$ with an intern working with Christophe Moy}
            \vspace*{10pt}
