...
\begin{frame}[shrink=25]
    ...
    \begin{tabular}{ m{3.5cm} | c | c | c | c | m{3cm} }
        \textbf{Algorithm} & \textbf{Paper} & $\cR(\cA, T)$ & \textbf{Efficiency} & \textbf{Cost} & \textbf{Parameters} \\
        \hline
        Oracle-Restart UCB & [1] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}_{\Upsilon_T,\mu}} \Upsilon_T \log(T))$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & \textcolor{red}{unrealistic oracle} \\
        ...
        \hline
        Exp3.S & [3] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}_{\Upsilon_T,\mu}} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & $(\varepsilon_t)_t$ needs $\Upsilon_T$ \\
        \hline
        ...
        \hline
        \textbf{\textcolor{blue}{GLRT + kl-UCB}} & [6] & $\mathcal{O}(\textcolor{blue}{\mathbf{C}_{\Upsilon_T,\mu}} \sqrt{T \Upsilon_T \log(T)})$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€€€}} & needs $\Upsilon_T$ \\
        \hline
