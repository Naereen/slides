...
\begin{frameO}[What did I study during my PhD ? ($1/2$)]
    ...
    % \begin{center}
        \centering
        \includegraphics[width=0.55\linewidth]{system_model1.eps}
...
\begin{frameO}[A UCB algorithm in action \hfill{} (movie)]
    ...
    \begin{center}
        \movie[autostart]{\includegraphics[width=0.9\textwidth]{KLUCB.pdf}}{KLUCB.avi}
    \end{center}
\end{frameO}
...
\begin{frameO}[We implemented this with real hardware ($1/3$)]
    ...
    and we presented it at the ICT 2018 and IEEE WCNC 2019 conferences.\\
    \emph{See Chapter 4.3.}

    \begin{center}
        \movie[autostart]{\includegraphics[width=0.6\textwidth]{screenshotDemoYouTube.png}}{videos/Multi-Armed_bandit_Learning_in_Iot_Networks_MALIN_-_Demo_at_ICT_2018.mkv}
    \end{center}
\end{frameO}
...
\begin{frameO}[We implemented this with real hardware ($2/3$)]
    \begin{center}
        \movie[autostart]{\includegraphics[width=0.9\textwidth]{screenshotDemoYouTube_Partie1.png}}{videos/Partie1.mp4}
    \end{center}
\end{frameO}
...
\begin{frameO}[We implemented this with real hardware ($3/3$)]
    \begin{center}
        \movie[autostart]{\includegraphics[width=0.9\textwidth]{screenshotDemoYouTube_Partie2.png}}{videos/Partie2.mp4}
    \end{center}
\end{frameO}


\section{Extensions using other Bandit Models}

\begin{frameTI}
    \begin{center}
        {\textcolor{white} {\Huge \textsc{Extensions using other Bandit Models} }}
    \end{center}
    \vspace*{-4pt}
\end{frameTI}
...
\begin{frame}[c]
    \begin{changemargin}{-0.5cm}{-0.5cm}
        \begin{center}
            \vspace{-0.3in}
            \textbf{\huge Extensions using other Bandit Models}
            \vspace{1.5cm}
    ...
    \only<3>{
        ...
        \begin{itemize}
            ...
            \item could players use the collision indicators to communicate? (yes!)\\
                $\implies$ \textbf{SIC-MMAB} strategy matches the centralized multiple-play lower-bound,
