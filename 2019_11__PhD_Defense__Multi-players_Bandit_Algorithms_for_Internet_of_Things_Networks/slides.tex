...
\begin{frameO}[What did I study during my PhD ? ($1/2$)]
    ...
    \begin{orangeblock}{Main questions}
        \begin{itemize}
            ...
            \item
            $\hookrightarrow$ \alert{can the devices learn on their own to communicate more efficiently?}
        \end{itemize}
    \end{orangeblock}
...
\begin{frameO}[What did I study during my PhD ? ($2/2$)]
    ...
    \begin{block}{Main solutions}
        ...
        \hspace{25pt} and we showed they are well suited for these problems!
    \end{block}
...
\begin{frameO}[Main contributions presented today]
    ...
    \begin{itemize}
        \item a model of IoT network with decentralized learning embedded in the devices,
        \item numerical simulations proving the quality of the proposed solution,
        \item mathematical development in a simplified model: multi-player bandit,
        \item extending beyond the stationary hypothesis,
