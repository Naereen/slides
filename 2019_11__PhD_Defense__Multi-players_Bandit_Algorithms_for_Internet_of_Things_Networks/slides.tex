...
\begin{frameO}[Conclusion from part I : Selfish MAB learning for IoT]
    ...
    \begin{itemize}
        ...
        \item
            Random activation times make the model \textbf{intractable} in theory
    \end{itemize}
...
\begin{frameO}[Many other bandits models and problems (2/2)]
    ...
    \begin{itemize}%[<+->]
        ...
        \item \textcolor{orange}{non stochastic, Markov models rested/restless}
        ...
        \item for some applications (content recommendation etc)
              ...
              \end{itemize}
        \item structured bandits (\textcolor{orange}{sparse}, low-rank, many-armed, Lipschitz etc)
...
\begin{frameO}[Multi-players bandits: setup]
    ...
    \begin{itemize}
        \item player $m$ selects arm $A_{m,t}$ \slotmachine{} ; then \textit{this arm generates} $r_{A_{m,t},t}$
    ...
    \[\red r_{m,t} = \left\{ \begin{array}{cl}
            r_{A_{m,t},t} & \text{if no other player chose the same arm} \\
    ...
    \begin{itemize}
        ...
        \item different observation models: players observe $r_{A_{m,t},t}$ and/or $r_{m,t}$
    \end{itemize}
...
\begin{frameO}[M-P bandits for Cognitive Radios: previous model]
    ...
    \begin{darkblock}{``Listen before talk''
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item
                observe first $r_{A_{m,t}, t}$,
                \item
                if $r_{A_{m,t}, t} = 1$, transmit and then observe the joint $r_{m,t}$,
                \item
...
\begin{frameO}[M-P bandits for Cognitive Radios: our models]
    ...
    \begin{lightblock}{``Observe collision then talk?''
        ...
        \begin{itemize}
            ...
            \item
            \emph{Feedback model:} First check if collision, then receive reward\newline
...
\begin{frameO}[Results on a multi-player MAB problem ($1/2$)]
    ...
    \begin{figure}
        ...
        \footnotesize{For $K=M$ objects, our strategy (MCTopM) achieves \textbf{constant} regret!}
    \end{figure}
...
\begin{frameO}[Results on a multi-player MAB problem ($2/2$)]
    ...
    \begin{figure}
        ...
        \small{For example for $M=6$ objects, our strategy (MCTopM) largely outperforms $\rho^{\text{rand}}$ and other previous state-of-the-art policies (not included).}
    \end{figure}
