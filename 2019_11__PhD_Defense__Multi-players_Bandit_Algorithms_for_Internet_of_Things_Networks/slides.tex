...
\begin{frameO}[Results on a multi-player MAB problem ($1/2$)]
    ...
    \begin{figure}
        ...
        % \includegraphics[height=0.75\textheight]{MP__K9_M9_T10000_N200__4_algos/all_RegretCentralized____env1-1_3201141303711964673.pdf}
        \footnotesize{For $K=M$ devices, \textcolor{blue}{our strategy MC-Top-$M$ ($\pentagon$)} achieves \textbf{constant} regret!\newline $\implies$ Our new orthogonalization procedure is very efficient!}
    \end{figure}
...
\begin{frameO}[Results on a multi-player MAB problem ($2/2$)]
    ...
    \begin{figure}
        ...
        \small{Ex: for $M=6$ devices, \textcolor{blue}{our strategy MC-Top-$M$ ($\pentagon$)} largely outperforms \textcolor{bluegreenrhorand}{$\rho^{\text{rand}}$} and other previous state-of-the-art policies (not included).}
    \end{figure}
