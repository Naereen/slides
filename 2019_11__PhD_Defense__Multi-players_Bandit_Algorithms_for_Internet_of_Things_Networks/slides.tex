...
\begin{frameO}[Transition: from practice to theory]
    ...
    \begin{itemize}
        ...
        \item
            Random activation times make the model \textbf{intractable} in theory\dots
    \end{itemize}
...
\begin{frameO}[Our proposed algorithm klUCB index + BGLR detector]
    ...
    \only<1>{
    \begin{colorblock}{Three parts of the algorithm \hfill{} \gray [Besson \& Kaufmann, 2019]}
        \begin{itemize}
    ...
    \only<2>{
    \begin{lightblock}{Theoretical guarantees}
        ...
        % \tightlist
            ...
            \item
                ...
                if $T$ and \textcolor{orange}{$\Upsilon_T$ are unknown}
        \end{itemize}
        {\small with precise constants in the $\mathcal{O}(\dots)$ depending on the problem difficulty\dots}
    \end{lightblock}
    }
