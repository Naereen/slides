...
\begin{frameO}[What did I study during my PhD ? ($1/2$)]
    ...
    \hfill{}
    \vspace*{-30pt}
    {\tiny \textcolor{gray}{[Bonnefoi, Besson et al, CROWNCOM 2017], Ch.4.2}}
...
\begin{frameO}[A first UCB algorithm]
    ...
    \begin{colorblock}{Hoeffding inequality + union bound \textcolor{gray}{[Auer et al. 2002]}}
...
\begin{frameO}[We implemented this with real hardware ($1/3$)]
    ...
    \end{center}
    {\tiny \textcolor{gray}{[Besson et al, ICT 2018], [Besson et al, WCNC 2019], Ch.4.3}}
\end{frameO}
