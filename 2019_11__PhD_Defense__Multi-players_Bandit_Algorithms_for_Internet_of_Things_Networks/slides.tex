...
\begin{frameO}[What did I study during my PhD ? ($1/2$)]
    ...
    \begin{block}{Telecommunications technology\dots}
    ...
    \begin{orangeblock}{Main questions}
        \begin{itemize}
            \item
...
\begin{frameO}[Organization of the thesis: a reading map]
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[>=latex',line join=bevel,scale=2.25]
            ...
            \node[align=center] (chapter3) at (-2.5,2.25) [rectangle,draw,fill=gray!10] {\textbf{Chapter~3}\\SMPyBandits: simulation\\library for MAB};
            \node[align=center] (chapter25) at (+2.5,2.25) [rectangle,draw,fill=gray!10] {\textbf{Chapter~4}\\Online selection\\of the best algorithm};
...
\begin{frameO}[Two naive strategies]
    ...
    \begin{itemize}
        \item \textbf{Idea 1 :}
              ...
              \begin{orangeblock}{}Draw each arm $T/K$ times\end{orangeblock}
    \end{itemize}
...
\begin{frameO}[Multi-players bandits: algorithms]
    ...
    \only<1>{
        \begin{orangeblock}{\textbf{Example:} UCB1 + $\rho^{\text{rand}}$. At round $t$ each player}
            \begin{itemize}
    ...
    \only<2->{
        \begin{orangeblock}{\textbf{Example:} our algorithm \textcolor{blue}{klUCB index + MC-TopM rule}}
            \begin{itemize}
                \only<2>{
...
\begin{frameO}[Piece-wise stationary bandits]
    ...
    \pause
    \begin{orangeblock}{\textbf{Piece-wise stationary} problems!}
...
\begin{frameO}[Regret for piece-wise stationary bandits]
    ...
    \begin{orangeblock}{Typical regimes for piece-wise stationary bandits}
        \begin{itemize}
            \item
                  The lower-bound is
