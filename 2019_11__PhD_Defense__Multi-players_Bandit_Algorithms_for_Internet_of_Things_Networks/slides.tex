...
\begin{frameO}[Main contributions presented today]
    ...
    \begin{itemize}
        ...
        \item theoretical results and proofs in a simplified model: multi-player bandits,
...
\begin{frameO}[We implemented this with real hardware]
    TODO
...
\begin{frameO}[Perspectives \hfill{} ($1/2$)]

    \begin{colorblock}{What is next ?}
        ...
        \begin{itemize}
            ...
            \item unify the multi-player and non-stationary bandit models\\
                $\hookrightarrow$ in progress
            \item test in real-world environment
            \item try to also let the devices learn \emph{when} to transmit, not only \emph{where/how} to transmit
        \end{itemize}
