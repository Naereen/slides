...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{2.7cm} | c | c | c | c | m{3cm} }
            ...
            & \parbox[c]{2cm}{\textbf{Efficiency} \newline {\footnotesize \textcolor{gray}{$\star$$\star$$\star$$\star$ is better}}}
            & \parbox[c]{1.5cm}{\textbf{Cost} \newline {\footnotesize \textcolor{gray}{€ is better}}}
            & \textbf{Parameters} \\
            \hline
            Centralized multiple-play klUCB & \textcolor{gray}{[1]} & $\textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{$\star$$\star$$\star$$\star$}} & {\textcolor{orange}{€}} & {just $M$ but \newline \textcolor{red}{in another model} } \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            $\rho^{\text{rand}}$ UCB & \textcolor{gray}{[2]} & $\textcolor{red}{M^3 \mathbf{C}_2} \log(T)$ & {\textcolor{orange}{$\star$$\star$}} & {\textcolor{orange}{€}} & just $M$ \\
            \hline
            \textsc{MEGA} & \textcolor{gray}{[3]} & $\mathbf{C}_3 \textcolor{red}{T^{3/4}}$ & {\textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & {\footnotesize 4 params, \newline \textcolor{red}{\emph{impossible to tune}} } \\
            \hline
            Musical Chair & \textcolor{gray}{[4]} & $\textcolor{red}{{2M \choose M} \mathbf{C}_4} \log(T)$ & {\textcolor{orange}{$\star$$\star$}} & {\textcolor{orange}{€}} & {\footnotesize 1 parameter $T_0$ \newline \textcolor{red}{\emph{hard to tune}} } \\
            \hline
            Selfish UCB & \textcolor{gray}{[5]} & $\textcolor{red}{T}$ in some case & {\textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & \textbf{none!} \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            \textcolor{blue}{\small \textbf{MCTopM klUCB}} & \textcolor{blue}{[6]} & $\textcolor{red}{M^2} \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{$\star$$\star$$\star$}} & {\textcolor{orange}{€€}} & just $M$ \\
            \hline
            \textsc{Sic-MMAB} & \textcolor{gray}{[7]} & $\textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T)$ & {\textcolor{orange}{$\star$$\star$$\star$}} & {\textcolor{orange}{€€€}} & \textbf{none!}
            % \\
    ...
    \begin{small}
        \textbf{Papers:}
            ...
            [6] \textcolor{blue}{[Besson \& Kaufmann, 18]}
    ...
    \begin{colorblock}{Typical regime for piece-wise stationary bandits}
        \begin{itemize}
            \item ``Oracle restart'' UCB obtains
                $\cR(\cA,T) \leq \mathcal{O}((K / \Delta_{\text{change}}^2) \Upsilon_T \log(T))$
...
\begin{frame}[shrink=23]
    ...
    \begin{tabular}{ m{3.5cm} | c | c | c | c | m{3cm} }
        ...
        & \textbf{Parameters} \\
        \hline
        Oracle-Restart UCB & \textcolor{gray}{[1]} & $\textcolor{blue}{\mathbf{C}} \Upsilon_T \log(T)$ & {\textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & {\footnotesize \textcolor{red}{unrealistic oracle}} \\
        Naive UCB & \textcolor{gray}{[1]} & \textcolor{red}{$T$} \emph{in worst case} & {\textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & \textbf{none!} \\
        \hline
        Discounted UCB & \textcolor{gray}{[2]} & $\textcolor{red}{\mathbf{C}_2} \sqrt{T \Upsilon_T} \textcolor{red}{\log(T)}$ & {\textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & $T$ and $\Upsilon_T$ \\
        Sliding-Window UCB & \textcolor{gray}{[2]} & $\textcolor{red}{\mathbf{C}_2'} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & $T$ and $\Upsilon_T$ \\
        \hline
        Exp3.S & \textcolor{gray}{[3]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & $\Upsilon_T$ \\
        Discounted TS & \textcolor{gray}{[4]} & \emph{not yet proven} & {\textcolor{orange}{$\star$$\star$}}  & {\textcolor{orange}{€}} & {\footnotesize \textcolor{red}{how to tune $\gamma$ ?}} \\
        \hline
        CUSUM-UCB & \textcolor{gray}{[5]} & $\textcolor{red}{\mathbf{C}_5} \sqrt{T \Upsilon_T \log(\frac{T}{\Upsilon_T})}$ & {\textcolor{orange}{$\star$$\star$$\star$}}  & {\textcolor{orange}{€€€}}& {\footnotesize $T$, $\Upsilon_T$ \textcolor{red}{and $\delta_{\min}$}} \\
        % \hline
        M-UCB & \textcolor{gray}{[6]} & $\textcolor{red}{\mathbf{C}_6} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$$\star$}} & {\textcolor{orange}{€€}} & {\footnotesize $T$, $\Upsilon_T$ \textcolor{red}{and $\delta_{\min}$}} \\
        \hline
        \textbf{\textcolor{blue}{BGLR + kl-UCB}} & \textcolor{blue}{[7]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$$\star$$\star$$\star$}} & {\textcolor{orange}{€€€}} & $T$ and $\Upsilon_T$ \\
        \hline
        AdSwitch & \textcolor{gray}{[8]} & $\textcolor{red}{\mathbf{C}_8} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{$\star$$\star$$\star$$\star$}} & {\textcolor{orange}{€€€€}} & just $T$ \\
        % \hline
        Ada-ILTCB$^+$ & \textcolor{gray}{[9]} & $\textcolor{red}{\mathbf{C}_9} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{?}} & {\textcolor{orange}{€€€€€}} & just $T$
    \end{tabular}
    ...
    \begin{small}
        \textbf{Papers:}
            ...
            [7] \textcolor{blue}{[Besson et al. 19]}
