...
\begin{frameO}[Welcome to my PhD defense]
    ...
    % Hi, I'm Lilian\dots
        ...
        {\huge Title: \textsc{Multi-players Bandit Algorithms for Internet of Things Networks}}
...
\begin{frameO}[Target of this study]
    ...
    \begin{darkblock}{Wireless networks\dots}
        ...
        We focus on the case of \textbf{\alert{Internet of Things}} networks (IoT) in unlicensed bands.
    \end{darkblock}
...
\begin{frameO}[Main questions]
    ...
    \begin{colorblock}{Main goals}
        \begin{itemize}
            \item
            Increase the battery life of IoT devices \includegraphics[height=0.37cm]{dynamic-devices.png}
            \item
...
\begin{frameO}[We implemented this with real hardware ($1/3$)]
    ...
    \end{center}
    \hfill{}
    {\tiny \textcolor{gray}{Ref: [Bonnefoi et al, ICT 2018], [Besson et al, WCNC 2019], Ch.5.3, \texttt{YouTu.be/HospLNQhcMk}}}
\end{frameO}
...
\begin{frameO}[Transition: from practice to theory]
    ...
    \begin{itemize}
        ...
        \item \underline{Hyp 1:} in avg. $p \times D$ dynamic devices \includegraphics[height=0.37cm]{dynamic-devices.png} are using $K$ channels \slotmachine{}
            \hfill{} $\implies$ so $p \leq \frac{K}{D}$ or $D \leq \frac{K}{p}$ gives best performance
        \item \underline{Hyp 2:} we assumed a stationary background traffic \includegraphics[height=0.37cm]{static-devices.png} \dots
    \end{itemize}
    ...
    \begin{colorblock}{}
        ...
        \begin{itemize}
            ...
            \item \underline{Model 2:} \textbf{non-stationary bandits} (for one device \includegraphics[height=0.37cm]{dynamic-devices.png})
        \end{itemize}
        \hfill{}
...
\begin{frameO}[The MC-Top-$M$ algorithm (for the OSA case)]
    ...
    \begin{figure}[h!]
        \scalebox{0.60}{\begin{minipage}{1.65\textwidth}  %% https://tex.stackexchange.com/a/366403/
...
\begin{frameO}[Piece-wise stationary bandits]
    ...
    \begin{blueblock}{Stationary MAB problems}
        Arm $k$ \slotmachine{} gives rewards sampled from \textcolor{blue}{the same distribution} for any time step
...
\begin{frameO}[Our algorithm Rand-Top-$M$]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__algo_RandTopM.png}
    \end{center}
\end{frameO}

\begin{frameO}[Our algorithm MC-Top-$M$]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__algo_MCTopM.png}
    \end{center}
\end{frameO}

\begin{frameO}[Lemma: bad selections for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__lemma_MCTopM_bad_selections.png}
    \end{center}
\end{frameO}

\begin{frameO}[Lemma: collisions for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__lemma_MCTopM_collisions.png}
    \end{center}
\end{frameO}

\begin{frameO}[Theoreom: regret for MC-Top-$M$ with kl-UCB]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__lemma_MCTopM_regret.png}
    \end{center}
\end{frameO}

\begin{frameO}[Our algorigthm GLRT and kl-UCB]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__algo_GLRT_klUCB.png}
    \end{center}
\end{frameO}

\begin{frameO}[Theorem: regret bound for GLRT + kl-UCB (global)]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__lemma_GLR_regret.png}
    \end{center}
\end{frameO}

\begin{frameO}[Corollary: regret bounds for GLRT + kl-UCB (global)]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__cor_GLR_regret.png}
    \end{center}
\end{frameO}
...
\begin{frameO}[Theorem: regret bound for GLRT + kl-UCB (local)]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__lemma_GLRlocal_regret.png}
    \end{center}
\end{frameO}

\begin{frameO}[Corollary: regret bounds for GLRT + kl-UCB (local)]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Backup_Slides__cor_GLRlocal_regret.png}
    \end{center}
\end{frameO}


% % FIXME rmettre pour la vraie soutenance ?
