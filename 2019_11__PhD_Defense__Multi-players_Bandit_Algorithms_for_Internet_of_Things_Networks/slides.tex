...
\begin{frameTI}
    ...
    and [Besson \& Kaufmann, 2018] and [Besson \& Kaufmann, 2019].}}
    % \hfill{} {\tiny \textcolor{gray}{[Bonnefoi, Besson et al, CROWNCOM 2017], Ch.5.2}}
\end{frameTI}
...
\begin{frameO}[M-P bandits for Cognitive Radios: previous model]
    ...
    \begin{colorblock}{``Listen before talk''
        \hfill{} {\tiny \textcolor{gray}{[Zhao et al. 2010], [Jouini et al. 2010], [Anandkumar et al. 2011]}}
    }
        \begin{itemize}
            \item
...
\begin{frameO}[M-P bandits for Cognitive Radios: our models]
    ...
    \begin{colorblock}{``Talk and maybe collide''
        \hfill{} \textcolor{gray}{[Besson \& Kaufmann, ALT 2018]}
    }
        \begin{itemize}
            \item
    ...
    \begin{colorblock}{``Observe collision then talk?''
        \hfill{} \textcolor{gray}{[Boursier et al, 2019]}
    }
        \begin{itemize}
            \item
...
\begin{frameO}[Results on a multi-player MAB problem ($2/2$)]
    ...
    \caption{\small{For example for $M=6$ objects, our strategy (MC-TopM) largely outperforms $\rho^{\text{rand}}$ and other previous state-of-the-art policies (not included).}}
...
\begin{frame}[shrink=25]
    ...
    \begin{tabular}{ m{3.5cm} | c | m{3.3cm} | m{2cm} | m{1.5cm} | m{3cm} }
        ...
        Naive UCB & \textcolor{gray}{[1]} & \textcolor{red}{$T$} in worst case & {\Large \textcolor{orange}{$\star$}}  & {\textcolor{orange}{€}} & \textbf{none} \\
        \hline
        ...
        \hline
        CUSUM-UCB & \textcolor{gray}{[4]} & $\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T / \Upsilon_T)}$ & {\Large \textcolor{orange}{$\star\star$}}  & {\textcolor{orange}{€€€}}& {\footnotesize needs $\Upsilon_T$ and $\delta$} \\
        % \hline
        M-UCB & \textcolor{gray}{[5]} & $\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)}$ & {\Large \textcolor{orange}{$\star\star$}} & {\textcolor{orange}{€€}} & {\footnotesize needs $\Upsilon_T$ and $\delta$} \\
        \hline
        \textbf{\textcolor{blue}{GLRT + kl-UCB}} & \textcolor{gray}{[6]} & $\textcolor{blue}{\mathbf{C}} \sqrt{T \Upsilon_T \log(T)}$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€€€}} & needs $\Upsilon_T$ \\
        \hline
        AdSwitch & \textcolor{gray}{[7]} & $\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)}$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€€€€}} & \textbf{none} \\
        % \hline
        Ada-ILTCB+ & \textcolor{gray}{[8]} & $\textcolor{red}{\mathbf{C}'} \sqrt{T \Upsilon_T \log(T)}$ & {\textcolor{orange}{?}} & {\textcolor{orange}{€€€€€}} & \textbf{none}
    \end{tabular}
    ...
    and $\delta < \Delta_{\text{change}}$ the problem difficulty.
    ...
    \begin{small}
        \textbf{References:}
            ...
            [4] \textcolor{gray}{[Liu et al. 18]}\\
            \hspace{20pt}
            [5] \textcolor{gray}{[Cao et al. 19]}
            [6] \textcolor{gray}{[Besson et al. 19]}
            [7] \textcolor{gray}{[Auer et al. 19]}
            [8] \textcolor{gray}{[Chen et al. 19]}
    \end{small}
