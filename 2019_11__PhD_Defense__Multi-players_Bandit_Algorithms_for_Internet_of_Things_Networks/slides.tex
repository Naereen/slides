...
\begin{frameTI}
    ...
    [Besson \& Kaufmann, 2018] and  [Besson \& Kaufmann, 2019].}}
    % \hfill{} {\tiny \textcolor{gray}{[Bonnefoi, Besson et al, CROWNCOM 2017], Ch.5.2}}
\end{frameTI}
...
\begin{frame}[shrink=20]
    ...
    \begin{center}
        \begin{tabular}{ m{3cm} | c | m{3cm} | c | c | m{3cm} }
            ...
            \hline
            Centralized multiple-play klUCB & [1] & $\mathcal{O}( \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T))$ & {\Large \textcolor{orange}{$\star\star\star\star$}} & {\textcolor{orange}{€}} & $M$ \textcolor{red}{in another model} \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            $\rho^{\text{rand}}$ UCB & [2] & $\mathcal{O}(\textcolor{red}{\mathbf{C}'} \log(T))$ & {\Large \textcolor{orange}{$\star\star$}} & {\textcolor{orange}{€}} & just $M$ \\
            \hline
            MEGA & [3] & $\mathcal{O}(\textcolor{red}{T^{3/4}})$ & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & 4 parameters, \emph{impossible to tune} \\
            \hline
            Musical-Chair & [4] & $\mathcal{O}({2M \choose M} \textcolor{red}{\mathbf{C}'} \log(T))$ & {\Large \textcolor{orange}{$\star\star$}} & {\textcolor{orange}{€}} & 1 parameter $T_0$ \emph{hard to tune} \\
            \hline
            Selfish UCB & [5] & $\mathcal{O}(\textcolor{red}{T})$ in some case & {\Large \textcolor{orange}{$\star$}} & {\textcolor{orange}{€}} & \textbf{none} \\
            % \vspace*{3pt}
            \hline
            % \vspace*{3pt}
            \textcolor{blue}{\textbf{MCTopM klUCB}} & [6] & $\mathcal{O}( M^2 \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T))$ & {\Large \textcolor{orange}{$\star\star\star$}} & {\textcolor{orange}{€€}} & just $M$ \\
            \hline
            \textsc{Sic-MMAB} & [7] & $\mathcal{O}( \textcolor{blue}{\mathbf{C_{M,\mu}}} \log(T))$ & {\Large \textcolor{orange}{$\star\star\star$}} & {\textcolor{orange}{€€€}} & \textbf{none}
        \end{tabular}
    \end{center}
