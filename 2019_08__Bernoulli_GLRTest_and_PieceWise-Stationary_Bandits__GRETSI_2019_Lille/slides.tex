...
\begin{frame}{Problèmes de bandits non stationnaires}
  ...
  \begin{block}{Problèmes de bandits \textbf{stationnaires par morceaux}}
    $\hookrightarrow$ on se concentre sur le cas où il y a au plus $o(\sqrt{T})$ intervals on which the means are all stationary (= \textbf{sequence})
  \end{block}
\end{frame}
...
\section{\hfill{}4. L'algorithme BGLR-T + klUCB
...
\begin{frame}{Summary}
  ...
  \begin{itemize}
    ...
    \item
    Our algorithm outperforms other efficient policies on Simulations numériques \dCooley\\
