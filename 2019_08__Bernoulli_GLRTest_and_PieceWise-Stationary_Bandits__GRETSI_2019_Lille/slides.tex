...
\begin{frame}{Le problème de détection de rupture}
  ...
  \begin{itemize}
    ...
    \item On sait que $X_t$ est générée par une distribution \alert{inconnue}\ldots
  \end{itemize}
  \only<1>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps1.pdf}}
  \only<2>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps2.pdf}}
  \only<3>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps3.pdf}}
  \only<4>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps4.pdf}}
  \only<5>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps5.pdf}}
  \only<6>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps6.pdf}}
  \only<7>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps7.pdf}}
  \only<8>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps8.pdf}}
  \only<9>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps9.pdf}}
  \only<10>{\includegraphics[width=0.90\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu__temps10.pdf}}
\end{frame}
...
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_facile_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_facile_connu.pdf}
%   \end{center}
% \end{frame}
\begin{frame}[plain]{Exemple facile de détection de rupture}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_moyen_inconnu.pdf}
  \end{center}
\end{frame}
\begin{frame}[plain]{Exemple facile de détection de rupture}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_moyen_connu.pdf}
  \end{center}
\end{frame}

\begin{frame}[plain]{Difficile avec peu d'échantillons ?}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_inconnu.pdf}
  \end{center}
\end{frame}
\begin{frame}[plain]{Difficile avec peu d'échantillons ?}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_facile__T_difficile_connu.pdf}
  \end{center}
\end{frame}
...
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_facile_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_facile_connu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_moyen_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_moyen_connu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_difficile_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_moyen__T_difficile_connu.pdf}
%   \end{center}
% \end{frame}
...
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_facile_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_facile_connu.pdf}
%   \end{center}
% \end{frame}
\begin{frame}[plain]{Difficile avec des moyennes trop proches ?}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_moyen_inconnu.pdf}
  \end{center}
\end{frame}
\begin{frame}[plain]{Difficile avec des moyennes trop proches ?}
  \begin{center}
    \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_moyen_connu.pdf}
  \end{center}
\end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_difficile_inconnu.pdf}
%   \end{center}
% \end{frame}
% \begin{frame}[plain]{Exemples de détection de rupture}
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures_exemple_rupture/exemple_rupture__mu_difficile__T_difficile_connu.pdf}
%   \end{center}
% \end{frame}
...
\begin{frame}{Qu'est-ce qu'un bon test de détection de rupture ?}
  ...
  \begin{block}{1. Pas de \textbf{fausse alarme}}
    ...
    \visible<2>{
      \hfill{} \alert{Premier extrême} : aucune fausse alarme si on détecte \emph{jamais} \dXey{}
    }
  \end{block}
  ...
  \begin{block}{2. Un \textbf{délai de détection} court}
    ...
    \visible<2>{
      \hfill{} \alert{Autre extrême} : délai nul si on détecte \emph{tout le temps} \dXey{}
    }
  \end{block}

  \visible<2>{
    $\implies$ résoudre le compromis entre \alert{les deux extrêmes} !
  }
...
\begin{frame}{(log) Rapport de vraisemblances de Bernoulli}
  ...
  $\mathcal{L}(n) = \frac{\sup\limits_{\textcolor{gold}{\mu_0,\mu_1,\tau < n}}\ell(X_1,\cdots,X_n ; \textcolor{gold}{\mu_0,\mu_1,\tau})}{\sup\limits_{\textcolor{deeppurple}{\mu_0}}\ell(X_1,\cdots,X_n ;\textcolor{deeppurple}{\mu_0})}$,
  % en utilisant les vraisemblances de Bernoulli, et les
...
%   \vspace*{-20pt} % WARNING
%   \begin{center}
%     \includegraphics[width=1.10\textwidth]{figures/Problem_1.pdf}
%   \end{center}
% \end{frame}
...
% \section{\hfill{}L'algorithme T-BGLR + klUCB\hfill{}}

% % \begin{frame}{4. L'algorithme T-BGLR + klUCB}
