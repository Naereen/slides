...
\begin{frame}{Notre algorithme combine le test BGRL + les indices kl-UCB}
  ...
  \begin{block}{Idées principales}
    \begin{itemize}
      ...
      \item On utilise le test BGLR \alert{pour détecter les ruptures sur le bras joué $A(t)$}
  ...
  \begin{exampleblock}{Les indices kl-UCB}
    \begin{itemize}
      \item $\tau_k(t)$ est le temps depuis le dernier redémarrage du bras $k$ before time $t$,
...
\begin{footnotesize}
  ...
  \begin{algorithm}[H]
      ...
      \KwData{\emph{Paramètre du algorithme} : $\alpha \in (0, 1)$, $\delta>0$ \tcp*[f]{peut utiliser $T$ et $\Upsilon_T$}}
