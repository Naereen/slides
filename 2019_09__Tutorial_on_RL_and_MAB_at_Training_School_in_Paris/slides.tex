...
\setbeamertemplate{footline}{ \hspace{5em} \textcolor{white} {Lilian Besson \& Émilie Kaufmann - \emph{Introduction to Multi-Armed Bandits} \hfill 23 September, 2019}\hspace{2em}\null \vspace*{3pt}}
\begin{frame}{#1}
\BODY
\end{frame}
}
...
\setbeamertemplate{footline}{\hspace{2cm} \raisebox{2.5ex}
	{{Lilian Besson \& Émilie Kaufmann - \emph{Introduction to Multi-Armed Bandits}}}\hfill
	\raisebox{2.5ex}
	{{23 September, 2019 - \insertframenumber / \inserttotalframenumber \hspace{5mm} \null }}}
\begin{frame}{#1}
\BODY
\end{frame}
}
...
\setbeamertemplate{footline}{\hspace{2cm} \raisebox{2.5ex}
    {\textcolor{white}{Lilian Besson \& Émilie Kaufmann - \emph{Introduction to Multi-Armed Bandits}}}\hfill
    \raisebox{2.5ex}
    {\textcolor{white}{23 September, 2019 - \insertframenumber / \inserttotalframenumber \hspace{5mm} \null }}}
...
\begin{frameO}[Who am I ?]
    ...
    \begin{itemize}
        ...
        \hfill{} \emph{Thanks to Émilie Kaufmann for most of the slides material!}
    \end{itemize}

    \vspace*{5pt}

    \begin{itemize}
        \item \href{https://perso.crans.org/besson/}{\textcolor{darkgreen}{\texttt{Lilian.Besson @ Inria.fr}}}
...
\begin{frameO}[Why talking about bandits today?]
    ...
    \begin{itemize}
        \item rewards maximization in a stochastic bandit model
              ...
              $\implies$ good introduction to RL !
        ...
        \item \red bandit tools \black are useful for RL
              ...
              (UCRL, bandit-based MCTS for planning in games\dots)
        ...
        \item and bandits have great applications to Cognitive Radio\\
              $\hookrightarrow$ \textcolor{blue}{see the next talk at 4pm !}
    \end{itemize}
\end{frameO}
...
\begin{frameO}[Outline of this talk]
    ...
    \begin{itemize}
        ...
        \item Mixing Exploration and Exploitation
        \item The Optimism Principle and Upper Confidence Bounds (UCB) Algorithms
        \item Asymptotically Optimal Algorithms
              % \item Worst-case Optimality
        \item A Bayesian Look at the Multi-Armed Bandit Model
...
\begin{frameO}[Cognitive radios]
    ...
    $\hookrightarrow$ \alert{see the next talk at 4pm !}
...
\begin{frameO}[A first UCB algorithm]
    ...
    \begin{itemize}
        ...
        \item popularized by \color{gray}[Auer et al. 02] \color{black} for bounded rewards:\\
              ...
              \hfill{} $\hookrightarrow$ \textcolor{blue}{see the next talk at 4pm !}
...
\begin{frameO}[Take-home messages \hfill{} ($1/2$)]
    ...
    $\implies$ And you can learn more about \blue more complex bandit problems \black and \blue Reinforcement Learning\black!

\end{frameO}

\begin{frameO}[Take-home messages \hfill{} ($2/2$)]
    ...
    \begin{itemize}
        ...
        \item applications of self-normalized concentration inequalities
        \item Bayesian tools\dots
    \end{itemize}
...
\begin{frameO}[Where to know more? \hfill{} ($1/3$)]
...
\begin{frameO}[Where to know more? \hfill{} ($2/3$)]
    ...
    \href{https://perso.crans.org/besson/}{\textcolor{darkgreen}{\texttt{Lilian.Besson @ Inria.fr}}}
...
\begin{frameO}[Where to know more? \hfill{} ($3/3$)]
...
\begin{frameO}[Conclusion]
    ...
    \begin{center}
        \begin{Large}
            $\hookrightarrow$ \textcolor{blue}{Break and then next talk by Christophe Moy}\\
