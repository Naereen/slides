    ...
    \only<3>{
        ...
        \begin{itemize}
            \item number of players $M$ has to be known\\
                $\rightarrow$ but it is possible to estimate it on the run
...
\begin{frameO}[Take-home messages \hfill{} ($1/2$)]
    ...
    $\implies$ And you are can learn more about \blue more complex bandit problems \black and \blue Reinforcement Learning\black!
