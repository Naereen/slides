...
\definecolor{lightred}{RGB}{174,0,0}  % rgb(174,0,0)
...
\item
  ...
  than \rhoRand's constant scaling as \(M{2M-1 \choose M}\)
\item
  We have some doubts regarding the proofs and results of all the
