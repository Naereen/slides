...
R_T(\boldsymbol{\mu}, M, \rho) \leq G_{M,\boldsymbol{\mu}} \times \log(T) + \smallO{\log T}.
\]
...
\item
  ...
  \hook demo (in progress) for the ICT \(2018\) conference (Saint-Malo, France)
\end{itemize}
...
\subsection{\hfill{}A.b. Sketch of the proof\hfill{}}
...
\subsection{\hfill{}A.b. Illustration of the proof\hfill{}}
