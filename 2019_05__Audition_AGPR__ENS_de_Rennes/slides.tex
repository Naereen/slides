...
% \begin{center}
%   ``\alert<4>{\textbf<4>{Apprentissage séquentiel multi-joueurs}} et \alert<3>{\textbf<3>{bandits multi-bras}} appliqués aux réseaux de l'\alert<2>{\textbf<2>{Internet des Objects}}''
% \end{center}
